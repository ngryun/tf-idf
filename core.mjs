...
export function createStopwordSet(customInput = "") {
...
export function tokenize(text, stopwordSet, options = {}) {
...
export function analyzeDocuments(inputDocuments, customStopwords = "", options = {}) {
